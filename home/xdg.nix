{ config, ... }:
{
    ...
    xdg.mimeApps = {
        ...
        associations.added = {
            ...
            "application/epub+zip" = [ "org.gnome.FileRoller.desktop" "org.gnome.gedit.desktop" "calibre.desktop" "okularApplication_epub.desktop" ];
            "application/json" = [ "org.gnome.gedit.desktop" ];
            "application/octet-stream" = [ "org.inkscape.Inkscape.desktop" "inkscape.desktop" "calc.desktop" ];
            "application/pdf" = [ "org.gnome.Evince.desktop" "okularApplication_pdf.desktop" "draw.desktop" "qpdfview.desktop" "inkscape.desktop" "evince.desktop" ];
            ...
            "application/x-kdenlive" = [ "org.kde.kdenlive.desktop" "org.gnome.gedit.desktop" ];
            "application/x-mobipocket-ebook" = [ "org.gnome.FileRoller.desktop" "org.gnome.gedit.desktop" ];
            ...
            "application/zip" = [ "org.gnome.FileRoller.desktop" "sublime_text.desktop" ];
            ...
            "font/otf" = [ "org.gnome.font-viewer.desktop" "org.gnome.gedit.desktop" ];
            "image/bmp" = [ "eog.desktop" ];
            "image/gif" = [ "org.gnome.eog.desktop" "eog.desktop" ];
            "image/jpeg" = [ "org.gnome.eog.desktop" "gimp.desktop" "org.inkscape.Inkscape.desktop" "eog.desktop" "inkscape.desktop" ];
            "image/jpg" = [ "eog.desktop" ];
            "image/pjpeg" = [ "eog.desktop" ];
            "image/png" = [ "org.gnome.eog.desktop" "gimp.desktop" "org.gnome.Evince.desktop" "inkscape.desktop" "eog.desktop" "org.gnome.gedit.desktop" "feh.desktop" ];
            "image/svg+xml-compressed" = [ "eog.desktop" ];
            "image/svg+xml" = [ "org.inkscape.Inkscape.desktop" "inkscape.desktop" "org.gnome.gedit.desktop" "eog.desktop" ];
            "image/tiff" = [ "eog.desktop" ];
            ...
            "text/plain" = [ "org.gnome.gedit.desktop" "calc.desktop" "okularApplication_txt.desktop" "evince.desktop" "atom.desktop" "org.kde.kdenlive.desktop" ];
            ...
            "video/x-flv" = [ "mpv.desktop" "org.gnome.Totem.desktop" "org.kde.kdenlive.desktop" "audacity.desktop" ];
